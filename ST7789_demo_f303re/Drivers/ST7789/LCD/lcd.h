...
#define LCD_HANDLE            hspi2  // @Ankur_edit: SPI2 used here

/* @Ankur_edit: added for STM32F303 Pin connections. Use same names as in CubeMX */
#define LCD_DC_PORT                LCD_DC_GPIO_Port
#define LCD_RST_PORT               LCD_RST_GPIO_Port /* Disable if your display has no RST pin */
#define LCD_CS_PORT                LCD_CS_GPIO_Port  /* Disable if your display has no CS pin */
//#define LCD_BL_PORT              LCD_BL_GPIO_Port  /* Enable if you need backlight control */
#define LCD_DC                LCD_DC_Pin
#define LCD_RST               LCD_RST_Pin /* Disable if your display has no RST pin */
#define LCD_CS                LCD_CS_Pin  /* Disable if your display has no CS pin */
//#define LCD_BL              LCD_BL_Pin  /* Enable if you need backlight control */
...
//#define LCD_240X240
//#define LCD_240X280
  #define LCD_240X320  // @Ankur_edit: added for 240X320
#endif
    ...
    #define LCD_Y_SHIFT 0
      ...
      #define LCD_HEIGHT 240
    #endif
  #elif defined LCD_240X320  // @Ankur_edit: added for 240X320
    #if (LCD_ROTATION == 0) || (LCD_ROTATION == 2)
      #define LCD_WIDTH  240
...
// @Ankur_edit: #define LCD_PIN(pin, out)   ( LCD_CON(pin,_GPIO_Port->BSRR) = (out ? LCD_CON(pin,_Pin) : LCD_CON(pin,_Pin)<<16 ))
#define LCD_PIN(port, pin, out) HAL_GPIO_WritePin(port, pin, (out) ? GPIO_PIN_SET : GPIO_PIN_RESET) // @Ankur_edit: HAL for pin set and reset as STM32F303 uses BRR and BSRR for set and reset
