...
void GUI_Setup(UG_DEVICE *device)
{
    ...
    //UG_WindowSetTitleTextFont (&wnd, &FONT_6X8);  // @Ankur_edit
    ...
    //UG_ButtonSetFont(&wnd, BTN_ID_0, &FONT_6X8);  // @Ankur_edit
    ...
    //UG_ButtonSetFont(&wnd, BTN_ID_1, &FONT_6X8);  // @Ankur_edit
    ...
    //UG_ButtonSetFont(&wnd, BTN_ID_2, &FONT_6X8);  // @Ankur_edit
    ...
    //UG_ButtonSetFont(&wnd, BTN_ID_3, &FONT_6X8);  // @Ankur_edit
    ...
    //UG_CheckboxSetFont(&wnd, CHB_ID_0, &FONT_6X8);  // @Ankur_edit
    ...
    //UG_CheckboxSetFont(&wnd, CHB_ID_1, &FONT_6X8);  // @Ankur_edit
    ...
    //UG_CheckboxSetFont(&wnd, CHB_ID_2, &FONT_6X8);  // @Ankur_edit
    ...
    //UG_CheckboxSetFont(&wnd, CHB_ID_3, &FONT_6X8);  // @Ankur_edit
    ...
    //UG_TextboxSetFont(&wnd, TXB_ID_0, &FONT_4X6);  // @Ankur_edit
    ...
    //UG_TextboxSetFont(&wnd, TXB_ID_1, &FONT_12X20);  // @Ankur_edit
    ...
    //UG_TextboxSetFont(&wnd, TXB_ID_2, &FONT_24X40);  // @Ankur_edit
    ...
    //UG_TextboxSetFont(&wnd, TXB_ID_3, &FONT_32X53);  // @Ankur_edit
